...
const BottomTab = () => {
  ...
  return (
    ...
    >
      <Tab.Screen name="Homek" component={Home} />
      <Tab.Screen name="Searchk" component={Search} />
      <Tab.Screen name="Reelsk" component={Reels} />
      <Tab.Screen name="Activityk" component={Activity} />
      <Tab.Screen name="Profilek" component={Profile} />
    </Tab.Navigator>
  );
};
